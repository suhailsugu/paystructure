"""
Django settings for paystructure project.
...
ROOT_URLCONF = 'paystructure.urls'
...
WSGI_APPLICATION = 'paystructure.wsgi.application'
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'paystructure.exceptions.exceptions.handle_exception',
